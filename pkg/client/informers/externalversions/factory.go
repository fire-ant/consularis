...
type SharedInformerFactory interface {
	...
	Consularis() consularis_io.Interface
}

func (f *sharedInformerFactory) Consularis() consularis_io.Interface {
	return consularis_io.New(f, f.namespace, f.tweakListOptions)
}
